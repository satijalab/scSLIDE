...
object <- readRDS("/brahms/jiangl/scSLIDE_vignette/dependencies/Raw_count_Subset_104k_Ahern_2022_Cell.rds")
...
If you want to explore if multiple DCs can be merged together, we can also fit a principal curve to the top few DCs to obtain a joint pseudo-trajectory line. Here we are fitting such curve for the top 2 DCs, and append it to the object.
